//
//  HXYChosenTicketTableViewCell.m
//  manmanda
//
...
@interface HXYChosenTicketTableViewCell()<HXYChangeCntViewDelegate>
@property (nonatomic, strong)UILabel *timeLabel;
@property (nonatomic, strong)UIButton *deleteBtn;
@property (nonatomic, strong) HXYChangeCntView *changeCntView;
@end

@implementation HXYChosenTicketTableViewCell
...
{
    if (!_changeCntView) {
        _changeCntView = [[HXYChangeCntView alloc]initWithFrame:CGRectMake(ScreenWidth - margin - 132, top, 132, height)];
...
{
    if ([_delegate respondsToSelector:@selector(HXYChosenTicketTableViewCell:)]) {
        [_delegate HXYChosenTicketTableViewCell:self];
    }
}
