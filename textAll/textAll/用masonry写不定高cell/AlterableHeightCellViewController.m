//
//  AlterableHeightCellViewController.m
//  textAll
//
...
@interface AlterableHeightCellViewController ()<UITableViewDelegate,UITableViewDataSource>
@property (nonatomic, strong) NSMutableArray *arr;
@end

@implementation AlterableHeightCellViewController
