...
//  textAll
//
//  Created by liangqi on 17/6/26.
//  Copyright © 2017年 hexiaoyi. All rights reserved.
//
/*
HXYButton *button = [[HXYCustomButton alloc]initWithType:HXYCustomButtonDirectionTypeVertical imageSize:CGSizeMake(40, 40) space:@4];
...
HXYButton *horizontalBtn = [[HXYCustomButton alloc]initWithType:HXYCustomButtonDirectionTypeHorizontal imageSize:CGSizeMake(20, 20) space:nil];
